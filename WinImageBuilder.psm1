...
function Convert-VirtualDisk {
    ...
    Write-Log "Converting Virtual Disk: $vhdPath..."
    $compressParam = ""
    ...
    Write-Log "Finished converting virtual disk."
}
...
function Copy-CustomResources {
    ...
    Write-Log "Copying Custom Resources: $CustomResources..."
    ...
    Write-Log "Custom Resources copied at: $ResourcesDir."
}
...
function Copy-UnattendResources {
    ...
    Write-Log "Copying Unattend Resources: $imageInstallationType..."
...
function Get-VirtIODrivers {
    ...
    return $driverPaths
    Write-Log "Finished getting IO Drivers."
}
...
function Add-VirtIODrivers {
    ...
    Write-Log "Adding VirtIO Drivers: $driversBasePath..."
    ...
    Write-Log "VirtIO Drivers have been added."
}
...
function Add-VirtIODriversFromISO {
    ...
    Write-Log "VirtIO Drivers have been adeed."
}
...
function Compress-Image {
    ...
    Write-Log "Started image compression at: $ImagePath..."
    ...
    Write-Log "Image compressed successfuly."
}
...
function Create-VirtualSwitch {
    ...
    Write-Log "Create Virtual Switch:$Name with adapter:$NetAdapterName..."
    if (!$NetAdapterName) {
    ...
    Write-Log "Successfuly created virtual switch: $vSwitch."
    return $vSwitch
}
